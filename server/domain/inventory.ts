...
export interface ReorderRecommendation extends DataScope { productId: Id; variantId?: Id; status: OperationalStatus; currentStock?: number; availableStock?: number; salesVelocityPerDay?: number; coverageDays?: number; estimatedStockoutAt?: string; reorderPoint?: number; reorderQuantity?: number; supplierId?: Id; supplierLeadTimeDays?: number; moq?: number; supplierUnitCost?: MinorUnit; reorderCost?: MinorUnit; missingInputs: string[]; explanations: string[]; source: Provenance; calculatedAt: string; }
...
export interface CashAwareDecision extends DataScope { id: Id; recommendation: ReorderRecommendation; status: OperationalStatus; lifecycle: DecisionStatus; currentCash?: MinorUnit; reorderCost?: MinorUnit; knownImmediateObligations?: MinorUnit; projectedCash?: MinorUnit; cashFloor?: MinorUnit; cashFloorStatus: "configured" | "not_configured"; missingInputs: string[]; calculatedAt: string; source: Provenance; }
