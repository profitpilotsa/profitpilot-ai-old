...
export interface InventoryState extends DataScope { id: Id; externalId?: Id; productId: Id; variantId?: Id; currentStock?: number; availableStock?: number; reservedStock?: number; inboundStock?: number; source: Provenance; status: OperationalStatus; observedAt: string; sourceUpdatedAt?: string; }
