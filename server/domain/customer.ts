...
export interface Customer extends DataScope { id: Id; externalId?: string; source: Provenance; displayName?: string; email?: string; phone?: string; status: OperationalStatus; createdAt?: string; sourceUpdatedAt?: string; }
